	...
	TH1F *summary1 = new TH1F("Pedestals", "Pedestals [DAC]", 9000, 0, 9000);
	TH1F *summary2 = new TH1F("Slope", "Slope [DAC/fC]", 200, -100, 100);
	TH1F *summary3 = new TH1F("Intercept", "Intecept [DAC]", 2000, -1000, 1000);
	TH1F *summary4 = new TH1F("Pedestals", "Pedestals [fC]", 1000, -100, 100);
	...
	TH1F *summary14 = new TH1F("PedestalsRMS", "Pedestals RMS [fC]", 1000, 0, 10);
